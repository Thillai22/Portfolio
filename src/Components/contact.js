    ...
    <>
      <div className="cpage" id="connect">
        <div className="contact">
          <div className="other">
            <div className="info">
              ...
              <div className="svg-wrap">
                ...
                <a href="https://github.com/Thillai22" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
          ...
          <div className="form">
            <h1>Get In Touch</h1>
            <form method="POST" action="https://script.google.com/macros/s/AKfycbzzD15wYpYhxYJVXp30RZoHvR2CAr0z0QwU27iNhnhMXX3QQw0I5QGadkhtplEBfoxZ/exec">
